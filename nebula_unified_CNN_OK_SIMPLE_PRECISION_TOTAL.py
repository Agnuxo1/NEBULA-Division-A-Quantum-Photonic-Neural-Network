...
# --- START: PyTorch 2.6+ Compatibility Fix ---
# Add custom classes to the safe globals list for torch.load()
# This is required to load checkpoints saved with older PyTorch versions
# or checkpoints containing custom class objects.
torch.serialization.add_safe_globals([
    '__main__.NEBULAConfig',
    '__main__.AdaptiveMemoryManager',
    '__main__.ThresholdOptimizer',
    'NEBULAConfig',
    'AdaptiveMemoryManager',
    'ThresholdOptimizer'
])
logger.info("PyTorch 2.6+ compatibility fix applied for loading checkpoints.")
# --- END: PyTorch 2.6+ Compatibility Fix ---
...
class Trainer:
    ...
    def load_checkpoint(self, path: str):
        ...
        # Set weights_only=False to load checkpoints containing custom classes from older PyTorch versions.
        # This is necessary due to a change in default behavior in PyTorch 2.6+.
        logger.info(f"Loading checkpoint with weights_only=False: {path}")
        ...
        logger.info(f"Checkpoint loaded successfully: {path}")
